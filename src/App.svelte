      ...
      <div class="flex h-16 justify-between">
        <div class="flex">
          <div class="hidden sm:-my-px sm:flex sm:space-x-8">
            <a href="#" class="inline-flex items-center border-b-2 border-violet-500 pt-1 text-sm font-medium text-gray-900" aria-current="page"> Kelpie Demo </a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="mx-auto my-8 flex max-w-5xl flex-col gap-10 sm:px-6 lg:px-8">
          ...
          <div class="flex flex-row items-end gap-4">
            <div class="flex w-full flex-col items-start gap-2">
              ...
              <select bind:value={model} id="model" name="model" class="shadow mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-violet-500 focus:outline-none focus:ring-violet-500 sm:text-sm">
            ...
            <div class="flex w-full flex-col items-start gap-2">
              ...
              <select bind:value={dataset} id="dataset" name="dataset" class="shadow mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-violet-500 focus:outline-none focus:ring-violet-500 sm:text-sm">
                <option>FB15k</option>
                <option>WN18</option>
            ...
            <div class="flex w-full flex-col items-start gap-2">
              ...
              <select bind:value={scenario} id="scenario" name="scenario" class="shadow mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-violet-500 focus:outline-none focus:ring-violet-500 sm:text-sm">
                  ...
                  <table class="min-w-full table-fixed divide-y divide-gray-300">
                    <thead class="bg-gray-100">
                      <tr>
                        ...
                        <th scope="col" class="min-w-[12rem] py-4 pr-3 text-left text-sm text-gray-900">Head Entity</th>
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white overflow-y-auto" style="height: 50vh;">
                      <!-- Selected: "bg-gray-50" -->
                      ...
                      <tr>
                        ...
                        <td class="max-w-xs truncate whitespace-nowrap px-3 py-4 text-sm text-gray-900">{R.path(['prediction', 'tail', 'entity'], p)}</td>
                      </tr>
                      {/each}
                    </tbody>
    ...
    <div class="mx-auto max-w-5xl px-4 pb-40 sm:px-6 lg:px-8">
      ...
      <div class="mt-4 flex flex-row justify-center items-center gap-4">
        <div class="max-w-5xl w-full grow">
          <div class="flex flex-col justify-center h-32 grow rounded-lg border-2 border-violet-400 bg-white px-4 py-5 sm:px-6">
        ...
        <div class="w-full flex h-32 flex-row grow items-center rounded-lg border-2 border-violet-400 bg-white px-4 sm:px-6">
        ...
        <div class="flex flex-col justify-center grow w-full h-32 rounded-lg border-2 border-violet-400 bg-white px-4 py-5 sm:px-6">
